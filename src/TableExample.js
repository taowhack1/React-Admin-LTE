...
const headCells = [
  ...
  { id: "tel", numeric: false, disablePadding: false, label: "เบอร์โทร" },
  { id: "ip", numeric: false, disablePadding: false, label: "ไอพี" },
  { id: "status", numeric: false, disablePadding: false, label: "สถานะอนุมัติ" },
  { id: "tool", numeric: false, disablePadding: false, label: ".." }
];
...
const EnhancedTableToolbar = props => { //ตกแต่ง toolbar 
    ...
    >
      {numSelected > 0 ? (
        ...
        <Typography className={classes.title} variant="h6" id="tableTitle">
            ...
            <ListItemText primary="ข้อมูลแจ้งซ่อม (รอคิวงาน)"/>
            </ListItem>
        </Typography>
      )}
